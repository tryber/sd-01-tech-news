...
# Código criado com ajuda do Gui e do Conrado!
# https://github.com/tryber/sd-01-tech-news/blob/guiiluiz-tech-news/
...
def get_news_writer(content):
    ...
    if author is None:
        ...
        if writer:
            ...
            name = selector.xpath("//p[contains(@class, 'z--m-none') and =contains(@class, 'z--truncate') and contains(@class,
...
def get_news_categories(content):
    selector = Selector(content)
    categories_list = selector.xpath("//a[contains(@class, 'tec--badge') and contains(@class,
